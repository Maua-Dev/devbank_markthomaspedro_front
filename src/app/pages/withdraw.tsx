...
const retirar = () => {
  ...
  const [withdraw, setWithdraw] = useState<withdrawResponse>();
      ...
      {showErrorModal && (
        <div className="modal-overlay">
          <div className="modal-content">
            ...
            <p className="modal-message">Saldo insuficiente para transação</p>
      ...
      {showSuccessModal && (
        <div className="modal-overlay">
          <div className="modal-content">
            ...
            <p className="modal-message">Saque realizado</p>
